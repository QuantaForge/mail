...
use Closure;
use QuantaForge\Contracts\Mail\Factory as FactoryContract;
...
class MailManager implements FactoryContract
{
     ...
     * @return \QuantaForge\Mail\Mailer
     */
     ...
     *
     * @param  array  $config
     * @return \QuantaForge\Mail\Transport\SesTransport
     */
     ...
     *
     * @param  array  $config
     * @return \QuantaForge\Mail\Transport\Se2VwTransport
     */
    ...
    protected function createFailoverTransport(array $config)
    {
        ...
        foreach ($config['mailers'] as $name) {
            ...
            // with any QuantaForge <= 6.x application style mail configuration files.
     ...
     *
     * @param  array  $config
     * @return \QuantaForge\Mail\Transport\LogTransport
     */
     ...
     *
     * @return \QuantaForge\Mail\Transport\ArrayTransport
     */
     ...
     *
     * @param  \QuantaForge\Mail\Mailer  $mailer
     * @param  array  $config
     * @param  string  $type
     * @return void
     */
    ...
    protected function getConfig(string $name)
    {
        ...
        // provide "BC" for any QuantaForge <= 6.x style mail configuration files.
    ...
    public function getDefaultDriver()
    {
        ...
        // of the QuantaForge mail configuration file for backwards compatibility.
