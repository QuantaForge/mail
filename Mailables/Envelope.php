...
namespace QuantaForge\Mail\Mailables;
...
class Envelope
{
     ...
     *
     * @var \QuantaForge\Mail\Mailables\Address|string|null
     */
    public $from;
     ...
     *
     * @param  \QuantaForge\Mail\Mailables\Address|string|null  $from
     * @param  array  $to
     * @param  array  $cc
     * @param  array  $bcc
     * @param  array  $replyTo
     ...
     *
     * @param  \QuantaForge\Mail\Mailables\Address|string  $address
     ...
     *
     * @param  \QuantaForge\Mail\Mailables\Address|array|string  $address
     * @param  string|null  $name
     * @return $this
     */
